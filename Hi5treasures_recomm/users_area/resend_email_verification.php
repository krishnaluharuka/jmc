...
if (isset($_POST['resend_email_verify'])) {
    ...
    if ($row_count == 1) {
        if ($row_data['user_type'] == 'Admin') {
            if ($row_data['verify_status'] == "0") {
                $name = $row_data['username'];
                $email = $row_data['user_email'];
                $verify_token = $row_data['verify_token'];
        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center py-5">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <h1 class="text-center py-3">RESEND <span class="px-4">VERIFICATION </span></h1><br>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-4 w-50 m-auto">
                            <input type="submit" name="resend_email_verify" class="mbtn5 m-auto" value="Submit">
                        </div>
                    </form>
                </div>
                    </div>
